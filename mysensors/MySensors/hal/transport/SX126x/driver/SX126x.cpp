...
static bool SX126x_initialise()
{
    ...
    uint32_t tcxoDelay = MY_SX126c_TCXO_STARTUP_DELAY << 6; // Delay has to be set as multiples of 16.25uS
...
static bool SX126x_txPower(sx126x_powerLevel_t power)
{
    ...
    sx126x_paSettings_t paSettings;// ={ 0x00, 0x00, 0x00};
	//paSettings.fields = {0, 0, 0, 0x01};
...
static void SX126x_ATC() {
    ...
    newPowerLevel = constrain(newPowerLevel, MY_SX126x_MIN_POWER_LEVEL_DBM, MY_SX126x_MAX_POWER_LEVEL_DBM);
