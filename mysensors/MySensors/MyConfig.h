...
#if defined(MY_RADIO_RF24) || defined(MY_RADIO_NRF5_ESB) || defined(MY_RADIO_RFM69) || defined(MY_RADIO_RFM95) || defined(MY_RADIO_SX126x) || defined(MY_RS485)
...
/**
 * @def CUBECELL
 * @brief Automatically set when building for CUBECELL AB01 targets
 */
